...
points = [30,35,40,45,50,55,60,65,70,75,80;...          %x
          60,60,60,60,60,60,60,60,60,60,60; ...    %y
          3,3,3,3,3,3,3,3,3,3,3]';  

points2 = [50,50,50,50,50,50,50,50,50,50,50,50;...          %x
           75,70,65,60,55,50,45,40,35,30,25,20; ...    %y
           3,3,3,3,3,3,3,3,3,3,3,3]';

points3 = [35,40,45,48,50,50,50,50,50,48,45,40,35,30;...          %x
           70,70,70,70,68,65,60,55,52,50,50,50,50,50; ...    %y
           3,3,3,3,3,3,3,3,3,3,3,3,3,3]';
points3(:,2)=points3(:,2)-10;
points3=flip(points3);

points4 = [30,35,40,45,50,55,60,65,70,75,80;...          %x
           50,50,50,50,50,50,50,50,50,50,50; ...    %y
           3,3,3,3,3,3,3,3,3,3,3]';
