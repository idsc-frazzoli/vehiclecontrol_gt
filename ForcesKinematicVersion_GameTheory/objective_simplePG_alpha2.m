function f = objective_simplePG_alpha2(z,pslack,xend1,xend2,yend1,yend2,alpha,pacc,psteer)
    global index
    ...
    f = alpha*(xcost1+ycost1+u1cost_v1+u2cost_v1)+xcost2+ycost2+u1cost_v2+...
