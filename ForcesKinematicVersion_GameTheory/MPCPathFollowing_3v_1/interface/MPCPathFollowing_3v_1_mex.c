...
#include "mex.h"
#include "math.h"
#include "../include/MPCPathFollowing_3v_1.h"
...
extern void MPCPathFollowing_3v_1_casadi2forces(MPCPathFollowing_3v_1_float *x, MPCPathFollowing_3v_1_float *y, MPCPathFollowing_3v_1_float *l, MPCPathFollowing_3v_1_float *p, MPCPathFollowing_3v_1_float *f, MPCPathFollowing_3v_1_float *nabla_f, MPCPathFollowing_3v_1_float *c, MPCPathFollowing_3v_1_float *nabla_c, MPCPathFollowing_3v_1_float *h, MPCPathFollowing_3v_1_float *nabla_h, MPCPathFollowing_3v_1_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
MPCPathFollowing_3v_1_extfunc pt2function_MPCPathFollowing_3v_1 = &MPCPathFollowing_3v_1_casadi2forces;


/* Some memory for mex-function */
static MPCPathFollowing_3v_1_params params;
static MPCPathFollowing_3v_1_output output;
static MPCPathFollowing_3v_1_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help MPCPathFollowing_3v_1_mex' for details.");
    }    
	if (nlhs > 3) 
	{
	...
	#if SET_PRINTLEVEL_MPCPathFollowing_3v_1 > 0
	...
	/* call solver */
	exitflag = MPCPathFollowing_3v_1_solve(&params, &output, &info, fp, pt2function_MPCPathFollowing_3v_1);
