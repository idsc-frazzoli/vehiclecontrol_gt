...
a Python wrapper for a fast solver generated by FORCES PRO v4.0.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - column vector of length 2000

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['alldata'] - column vector of size 480
...
#	def from_param(self):
#		return self
	_fields_ = [('x0', ctypes.c_double * 480),
('xinit', ctypes.c_double * 7),
('all_parameters', ctypes.c_double * 2000),
]
...
#	def from_param(self):
#		return self
	_fields_ = [('alldata', ctypes.c_double * 480),
]
