function f = objective_PG_2(z,points,radii,points2,radii2,vmax, maxxacc,maxyacc,latacclim,rotacceffect,torqueveceffect, brakeeffect,plagerror, platerror, pprog, pab, pdotbeta, pspeedcost,pslack,pslack2)
    global index
    ...
    f = lagcost+latcost+reg+prog+pslack*slack+speedcost+...
        0.5*(lagcost_k2+latcost_k2+reg_k2+prog_k2+pslack*slack_k2+...
