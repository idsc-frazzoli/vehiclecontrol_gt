function f = objective_PG3_LE(z,points,radii,points2,radii2,points3,radii3,vmax, maxxacc,maxyacc,latacclim,rotacceffect,torqueveceffect, brakeeffect,plagerror, platerror, pprog, pab, pdotbeta, pspeedcost,pslack,pslack2)
    global index
