function f = objective_PG3_LE(z,points,points2,points3,vmax,plagerror, platerror, pprog, pab, pdotbeta, pspeedcost,pslack,pslack2)
    ...
    %
    f = (lagcost+latcost+latcost1+reg+speedcost)+pslack*slack+...prog
        (lagcost_k2+latcost_k2+latcost1_k2+reg_k2+speedcost_k2)+pslack*slack_k2+...+prog_k2
        (lagcost_k3+latcost_k3+latcost1_k3+reg_k3+speedcost_k3)+pslack*slack_k3+...+prog_k3
