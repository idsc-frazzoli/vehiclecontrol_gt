...
%      (   +   +regAB   +regBeta   +speedcost1+speedcost)+...prog+pslack*slack+
%         (+regAB_k2+regBeta_k2+speedcost1_k2+speedcost_k2)+...+prog_k2+pslack*slack_k2+
%         (+regAB_k3+regBeta_k3+speedcost1_k3+speedcost_k3)+...+prog_k3+pslack*slack_k3+
    f = lagcost+latcost+lagcost_k2+latcost_k2+lagcost_k3+latcost_k3+pslack2*slack2+pslack2*slack3+pslack2*slack4;
end
