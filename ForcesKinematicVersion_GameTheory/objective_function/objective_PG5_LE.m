function f = objective_PG5_LE(z,points,points2,points3,points4,points5,vmax,plagerror, platerror, pprog, pab, pdotbeta, pspeedcost,pslack,pslack2)
    ...
    f = lagcost   +latcost   +latcost1   +reg   +prog   +pslack*slack   +speedcost   +...
        lagcost_k2+latcost_k2+latcost1_k2+reg_k2+prog_k2+pslack*slack_k2+speedcost_k2+...
        lagcost_k3+latcost_k3+latcost1_k3+reg_k3+prog_k3+pslack*slack_k3+speedcost_k3+...
        lagcost_k4+latcost_k4+latcost1_k4+reg_k4+prog_k4+pslack*slack_k4+speedcost_k4+...
        lagcost_k5+latcost_k5+latcost1_k5+reg_k5+prog_k5+pslack*slack_k5+speedcost_k5+...
