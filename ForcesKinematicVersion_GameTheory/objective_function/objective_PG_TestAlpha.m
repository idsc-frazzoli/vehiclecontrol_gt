function [lagcost,latcost,reg,prog,slack,speedcost,lagcost_k2,...
          latcost_k2,reg_k2,prog_k2,slack_k2,speedcost_k2,f,f1,f2] =...
          objective_PG_TestAlpha(z,points,points2,vmax,plagerror,...
    ...
    f = lagcost+latcost+reg+pslack*slack+alpha1*speedcost+...
        ...
        alpha2*speedcost_k2+pslack2*slack2;
    f1 = lagcost+latcost+reg++pslack*slack+speedcost;
    f2 = lagcost_k2+latcost_k2+reg_k2+pslack*slack_k2+...
        speedcost_k2;
end
