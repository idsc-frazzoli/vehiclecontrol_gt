...
platerror=0.4;    % lateral error param cost
pprog=2;         % progress parameter cost
pab=0.004;        % acc parameter cost
% pdotbeta=2;      % steering velocity parameter cost
% pspeedcost=0.08;    % parameter for cost that occurs when max_speed is exceeded
pdotbeta=0.6;      % steering velocity parameter cost
pspeedcost=3;    % parameter for cost that occurs when max_speed is exceeded
...
points = [0,5,10,20,30,35,40,45,50,55,60,65,70,75;...          %x,75,80,85,90,95
...
points2 = [50,50,50,50,50,50,50,50,50,50,50,50,50,50;...          %x,50,50,50,50,50
          25,30,35,40,45,50,55,60,65,75,85,95,100,110; ...    %y,75,80,85,90,95
          1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5]';  %,5,5,5,5,5
...
points3 = [48.25,48.25,48.25,48.25,48.25,48.25,52,55,60,70,82,95,100,110;...          %x,50,50,50,50,50,50,65,65,50
