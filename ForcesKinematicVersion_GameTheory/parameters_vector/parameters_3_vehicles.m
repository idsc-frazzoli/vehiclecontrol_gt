...
NUM_const=21; % number of nonlinear constraint
...
points = [30,35,40,45,50,55,60,65,70;...          %x,75,80,85,90,95
          50,50,50,50,50,50,50,50,50; ...    %y,50,50,50,50,50
          3,3,3,3,3,3,3,3,3]'; %,5,5,5,5,5  
points2 = [50,50,50,50,50,50,50,50,50;...          %x,50,50,50,50,50
          30,35,40,45,50,55,60,65,70; ...    %y,75,80,85,90,95
          3,3,3,3,3,3,3,3,3]';  %,5,5,5,5,5
points3 = [50,50,50,50,50,50,50,50,50;...          %x,50,50,50,50,50,50,65,65,50
           70,65,60,55,50,45,40,35,30; ...    %y,25,20,15,10,5,0,5,92,95
           3,3,3,3,3,3,3,3,3]';%,5,5,5,5,4,3,2,2,3
