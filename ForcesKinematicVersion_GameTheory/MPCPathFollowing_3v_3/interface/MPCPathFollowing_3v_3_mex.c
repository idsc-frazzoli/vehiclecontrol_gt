...
#include "mex.h"
#include "math.h"
#include "../include/MPCPathFollowing_3v_3.h"
...
extern void MPCPathFollowing_3v_3_casadi2forces(MPCPathFollowing_3v_3_float *x, MPCPathFollowing_3v_3_float *y, MPCPathFollowing_3v_3_float *l, MPCPathFollowing_3v_3_float *p, MPCPathFollowing_3v_3_float *f, MPCPathFollowing_3v_3_float *nabla_f, MPCPathFollowing_3v_3_float *c, MPCPathFollowing_3v_3_float *nabla_c, MPCPathFollowing_3v_3_float *h, MPCPathFollowing_3v_3_float *nabla_h, MPCPathFollowing_3v_3_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
MPCPathFollowing_3v_3_extfunc pt2function_MPCPathFollowing_3v_3 = &MPCPathFollowing_3v_3_casadi2forces;


/* Some memory for mex-function */
static MPCPathFollowing_3v_3_params params;
static MPCPathFollowing_3v_3_output output;
static MPCPathFollowing_3v_3_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if( mxGetM(par) != 2340 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.x0 must be of size [2340 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.x0,2340);
	...
	{
    mexErrMsgTxt("PARAMS.xinit must be of size [27 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.xinit,27);
    ...
    if( mxGetM(par) != 8520 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [8520 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,8520);

	}


	#if SET_PRINTLEVEL_MPCPathFollowing_3v_3 > 0
	...
	/* call solver */
	exitflag = MPCPathFollowing_3v_3_solve(&params, &output, &info, fp, pt2function_MPCPathFollowing_3v_3);
	...
	plhs[0] = mxCreateStructMatrix(1, 1, 1, outputnames);
		outvar = mxCreateDoubleMatrix(2340, 1, mxREAL);
	copyCArrayToM_double( output.alldata, mxGetPr(outvar), 2340);
