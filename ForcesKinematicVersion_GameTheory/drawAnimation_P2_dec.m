...
frames = tend;
vidfile = VideoWriter('PotGame2P_cen','Motion JPEG AVI');
...
for iff = 1:frames-1
    ...
    plot(plansx4(iff+1,:),plansy4(iff+1,:),'-k','LineWidth',6);
    ...
    theta2 = atan2(plansy4(iff+1,2)-plansy4(iff+1,1),plansx4(iff+1,2)-plansx4(iff+1,1)); % to rotate 90 counterclockwise
    R2 = [cos(theta2) -sin(theta2); sin(theta2) cos(theta2)];
    rgklp2 = [plansx4(iff+1,1);plansy4(iff+1,1)]+R2*gklp;
