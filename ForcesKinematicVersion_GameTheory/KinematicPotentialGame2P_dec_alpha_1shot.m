...
plot(2-alpha2(kk),optA(kk),'*','Color',[0,alpha2(kk)/max(alpha2),1])
plot(2-alpha2(kk),optB(kk),'*','Color',[1,alpha2(kk)/max(alpha2),0])
end
...
plot(2-alpha2(kk),optA(kk)/(optA(kk)+optB(kk))*100,'*','Color',[0,alpha2(kk)/max(alpha2),1])
plot(2-alpha2(kk),optB(kk)/(optA(kk)+optB(kk))*100,'*','Color',[1,alpha2(kk)/max(alpha2),0])
end